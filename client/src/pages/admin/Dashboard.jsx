        ...
        <div className="flex h-screen bg-secondary overflow-hidden">
            ...
            >
                ...
                <nav className="flex-grow p-4 space-y-2 mt-6">
                    {navItems.map((item) => (
                        <Link
                            key={item.path}
                            to={item.path}
                            className={`flex items-center gap-4 px-4 py-3 rounded-xl transition-all ${(item.path === '' && location.pathname === '/admin/dashboard') ||
                ...
                <div className="p-4 border-t border-white/10">
                    <button
                        ...
                        className="flex items-center gap-4 px-4 py-3 w-full text-gray-400 hover:text-white hover:bg-white/5 rounded-xl transition-all"
                    >
                        <LogOut size={20} />
            ...
            <main className="flex-grow flex flex-col overflow-hidden">
                ...
                <header className="bg-white h-20 flex items-center justify-between px-8 lg:px-12 shadow-sm border-b border-gray-100 shrink-0">
                    <button onClick={() => setSidebarOpen(!sidebarOpen)} className="text-primary hover:bg-secondary p-2 rounded-lg">
